...
impl Completions {
    ...
    pub async fn create<'a>(&self, body: ChatCompletionCreateParams<'a>) -> Result<ChatCompletion, Box<dyn Error>> {
...
impl<'a> Default for ChatCompletionMessageParam<'a> {
    fn default() -> Self {
        ChatCompletionMessageParam::Assistant{ content: None, name: None, tool_calls: None }
    }
}
