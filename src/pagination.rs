...
// }
//
// trait MyTrait<T> where T: A + B {
//   fn new(t: T) -> Self;
//   fn my_trait(&self) -> String;
// }
//
// struct Structure<T> where T: A + B {
//   a: T,
// }
//
// impl <T: A + B> MyTrait<T> for Structure<T> {
//   fn new (t: T) -> Self {
//     Structure {
//       a: t,
//     }
...
// struct Example;
//
// impl SubA for Example {
//   fn o(&self) -> String {
//     "o method".to_string()
//   }
// }
//
// impl SubB for Example {}
//
// impl A for Example {
//   fn a(&self) -> String {
//     "a method".to_string()
...
//
// fn main() {
//   let structure = Structure::new(Example {});
//   println!("{}", structure.my_trait());
// }
